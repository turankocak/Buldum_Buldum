module.exports.buldum = function(){
    return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
      ...
      document.getElementById("harita").setAttribute("src","https://maps.google.com.tr/?q= "+ position.coords.latitude +" "+ position.coords.latitude + " &output=embed")
        ...
        <div class="panel">
            ...
            <div class="contact-form"> 
                <form method="post">
                    <div class="txtb">
                        <input id="Ne Buldun" name="Urun_Adi" type="text" placeholder="Ne Buldun?">
                    </div>    
                    <div class="txtb">
                         <label> <font color="gray" >Ürün Hakkında Detaylı bilgi ?</font></label>
                        <textarea cols="38" type="text" rows="5" name="Urun_Detayi"> </textarea>
                    </div>
                    <div class="txtb">
